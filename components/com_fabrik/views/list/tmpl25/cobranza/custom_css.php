...
#filter_gjr_cobranza___vencimiento input { width: 30%; display: inline-block; }

table th.gjr_cobranza___descripcion,
table td.gjr_cobranza___descripcion { max-width: 200px; }
";
?>