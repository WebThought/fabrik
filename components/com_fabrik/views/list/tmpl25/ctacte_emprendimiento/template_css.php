...
#listform_$c table th {
	text-align: center;
}

#listform_$c table td.saldo {
	font-weight: bold;
}

#listform_$c table th.fabrik_select,
#listform_$c table td.fabrik_select,
#listform_$c table th.gjr_view_ctacte_emprendimiento___simbolo,
#listform_$c table td.gjr_view_ctacte_emprendimiento___simbolo {
	display: none;
}

#listform_$c table.moneda td {
	min-width: 50px;	
}
