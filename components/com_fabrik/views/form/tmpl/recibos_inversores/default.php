...
require_once JPATH_ROOT . DIRECTORY_SEPARATOR . 'plugins/fabrik_form/php/scripts/helper_recibosinversores.php';

/* Creación de objetos JS para relleno de datos */
$dataObject = new stdClass();
$this->handler = new HandlerRecibosInversores($_SESSION['__default'], $dataObject);
?>
