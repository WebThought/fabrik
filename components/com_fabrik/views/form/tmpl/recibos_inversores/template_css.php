...
#recibo_inversor { border: 2px solid #990000; padding: 1em 2em; margin: 10px auto; }
#recibo_inversor h1 { text-transform: uppercase; text-align: center; }
#recibo_inversor h1 small { text-transform: lowercase !important; }
#recibo_inversor .inline-input,
#recibo_inversor .inline-input .fabrikElementContainer { display: inline-block !important; }
#recibo_inversor .inline-input label { display: none; }
#recibo_inversor p,
#recibo_inversor .paragraph { text-align: justify; margin-top: 1.5em; }
#recibo_inversor h3 { text-align: center; }
#recibo_inversor .nombre_emprendimiento { text-transform: uppercase; font-weight: bold; }
#recibo_inversor .aportestextos,
#recibo_inversor .aportestextos input { text-transform: uppercase; font-weight: bold; }
#recibo_inversor .descripcionproyecto label { display: none; }
#recibo_inversor .firma,
#recibo_inversor .firma textarea { text-align: center; }
#recibo_inversor .lugarfecha textarea { width: 100%; }
#recibo_inversor table.gastos tr td:first-child { white-space: nowrap; }
#recibo_inversor .gasto { font-weight: bold; }

@media print {
	.printlink, h1 { display: none !important; }
	#recibo_inversor h1 { display: block !important; font-size: 1.5em; font-weight: bold; }
	#recibo_inversor h1 small { font-size: .6em; }
	#recibo_inversor h3 { font-size: 1.1em; font-weight: bold; }	
}
