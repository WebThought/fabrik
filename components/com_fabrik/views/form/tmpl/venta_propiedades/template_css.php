...
#{$view}_$c .fabrikSubLabel { margin-left: -10px; clear: left; margin-top: 10px; float: left; }
.fabrikSubElement { display: block; margin-top: 10px; }

/* Dates */
.form-group .date input[type=\"text\"] { width: 90%; margin-right: 5px; float: left; }
.form-group .date .calendarbutton { float: left; }

#gjr_venta_propiedad___forma_pago ul { list-style: none; padding: 0; margin: 0; }
#gjr_venta_propiedad___forma_pago ul li input,
#gjr_venta_propiedad___forma_pago ul li input span { float: left; }

/* Cuota Vencimiento */
.fabrikRepeatGroup___gjr_venta_propiedad_80_repeat___especial_vencimiento .fabrikSubElementContainer { display: none; }

/* Forma de Pago */
#{$view}_$c .forma-pago .fabrikLabel.faux-label { display: none; }

#group81 a.btn { margin-top: 23px; }
